...
function renderDocumentPreview() {
    ...
    state.parsedBlocks.forEach(b => {
        ...
        if (b.type === 'level1') {
            ...
            if (b.number) {
                bHtml = `<div class="prev-clause-item prev-clause-level1" style="position: relative; padding-left: ${l2Wrap}mm; padding-top: ${spaceBeforePt}pt; padding-bottom: ${spaceAfterPt}pt; margin: 0; font-weight: ${l1Bold ? 'bold' : 'normal'}; text-decoration: ${textDecor}; text-transform: ${l1Upper ? 'uppercase' : 'none'}; color: ${primaryColor}; font-size: ${l1Size}pt;"><span class="prev-num-bold" style="position: absolute; left: ${l1Offset}mm; top: ${spaceBeforePt}pt; font-weight: bold; color: ${primaryColor}; text-decoration: none;">${escapeHTML(b.number)}</span><span class="prev-heading-text">${formattedHeading}</span></div>`;
            } else {
                bHtml = `<div class="prev-clause-item prev-clause-level1" style="padding-left: ${l1Offset}mm; padding-top: ${spaceBeforePt}pt; padding-bottom: ${spaceAfterPt}pt; margin: 0; font-weight: ${l1Bold ? 'bold' : 'normal'}; text-decoration: ${textDecor}; text-transform: ${l1Upper ? 'uppercase' : 'none'}; color: ${primaryColor}; font-size: ${l1Size}pt;">${formattedHeading}</div>`;
            }
...
async function generateAndExportDocument(formatOverride = null) {
    ...
    if (statusBox) {
        ...
        statusBox.innerHTML = `<div class="spinner-row"><span>Compiling formatted document &amp; PDF package...</span></div>`;
    }
